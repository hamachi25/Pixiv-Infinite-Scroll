export const Bookmark = (props: React.SVGProps<SVGSVGElement> & { active: boolean }) => {
	const { active, ...svgProps } = props;
	return (
		<svg
			className="transition-[fill,colors] duration-200"
			style={{
				fill: active ? "var(--charcoal-like)" : "rgb(31, 31, 31)",
			}}
			viewBox="0 0 32 32"
			width={32}
			height={32}
		...
		>
			...
			<path
				...
				style={{
					fill: active ? "var(--charcoal-like)" : "var(--charcoal-text5)",
				}}
